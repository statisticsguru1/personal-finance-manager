...
- [API (Plumber)](../API/docs/index.html)
- [R Package (`finman`)](../finman/docs/index.html)
...
Proprietary License. See [LICENSE](https://github.com/statisticsguru1/finance-manager/finman/LICENSE.md) for details.
